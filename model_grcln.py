...
class social_stgcnn(nn.Module):
    def __init__(self,n_stgcnn =1,n_txpcnn=1,input_feat=2,output_feat=5,
                 seq_len=8,pred_seq_len=12,kernel_size=3, z_dim=32):
        ...
        self.fc_mu = nn.Linear(output_feat, z_dim)
        self.fc_std = nn.Linear(output_feat, z_dim)

        self.trans = nn.Linear(z_dim, output_feat)
    ...
    def align(self, x, a):
        ...
        x = self.prelus[0](self.tpcnns[0](x))
        ...
        return z,a,mu,log_var

        
    def forward(self,v,a):
       
        v,a, mu, var = self.encode(v,a)
